...
CPM15_TRAIN_IMG_DIR  = "/kaggle/input/datasets/kartikmaity/tnbc-monuseg-segmentation/CPM15_CPM17_KUMAR/CPM15_CPM17_KUMAR/cpm15/WithSplit/train/images"
CPM15_TRAIN_MASK_DIR = "/kaggle/input/datasets/kartikmaity/tnbc-monuseg-segmentation/CPM15_CPM17_KUMAR/CPM15_CPM17_KUMAR/cpm15/WithSplit/train/masks"
CPM15_VAL_IMG_DIR    = "/kaggle/input/datasets/kartikmaity/tnbc-monuseg-segmentation/CPM15_CPM17_KUMAR/CPM15_CPM17_KUMAR/cpm15/WithSplit/validation/images"
CPM15_VAL_MASK_DIR   = "/kaggle/input/datasets/kartikmaity/tnbc-monuseg-segmentation/CPM15_CPM17_KUMAR/CPM15_CPM17_KUMAR/cpm15/WithSplit/validation/masks"
CPM15_TEST_IMG_DIR   = "/kaggle/input/datasets/kartikmaity/tnbc-monuseg-segmentation/CPM15_CPM17_KUMAR/CPM15_CPM17_KUMAR/cpm15/WithSplit/test/images"
CPM15_TEST_MASK_DIR  = "/kaggle/input/datasets/kartikmaity/tnbc-monuseg-segmentation/CPM15_CPM17_KUMAR/CPM15_CPM17_KUMAR/cpm15/WithSplit/test/masks"
...
def build_official_split(train_img_dir, train_mask_dir,
    ...
    print(f"  Official CPM15 split  ->  train: {len(train_ds)} | "
...
def train_official_split(train_img_dir=CPM15_TRAIN_IMG_DIR, train_mask_dir=CPM15_TRAIN_MASK_DIR,
                          val_img_dir=CPM15_VAL_IMG_DIR,     val_mask_dir=CPM15_VAL_MASK_DIR,
                          test_img_dir=CPM15_TEST_IMG_DIR,   test_mask_dir=CPM15_TEST_MASK_DIR,
                          img_size=IMG_SIZE, batch_size=BATCH_SIZE, num_epochs=NUM_EPOCHS,
                          lr=LR, weight_decay=WEIGHT_DECAY,
                          use_weighted_sampler=False, checkpoint="best_model_cpm15.pth",
                          seed=SEED):
    print(f"\n{'='*62}\n  BISON  |  CPM15 official Train/Validation/Test split")
    print(f"  Device : {DEVICE}  |  img_size={img_size}  batch={batch_size}")
    print(f"  Phase5 : attention_gates={USE_ATTENTION_GATES}  boundary_skips={USE_BOUNDARY_SKIPS}")
    print(f"  SBA    : heads={SBA_HEADS}  k_dim={SBA_K_DIM}  "
          f"desc_mode={BOUNDARY_DESC_MODE}  log_channel={USE_LOG_CHANNEL}  "
